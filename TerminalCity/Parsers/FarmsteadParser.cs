...
{
    public static List<FarmsteadTemplate> LoadAllFromFile(string filePath)
    {
        var templates = new List<FarmsteadTemplate>();
        ...
        foreach (var line in lines)
        {
            ...
            if (trimmed.StartsWith("[") && trimmed.EndsWith("]"))
            {
                ...
                if (currentSection == "farmstead")
                {
                    ...
                    if (template != null)
                    {
                        template.MapRows = new List<string>(mapLines);
                        template.Legend = new Dictionary<char, string>(legend);
